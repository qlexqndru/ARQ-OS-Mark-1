...

{
  config =
    let
      ...
      '';
    in
    lib.mkIf (cfg.desktop == "xhyprland") {
     ...
     #     { timeout = 1860; command = "systemctl suspend"; } # TODO: Check if this is a good way to suspend machine after screen turns off
      ...
      xdg = {
        ...
        configFile."hypr/swallhor.jpg" = {
          source = ../../assets/swallhor.jpg;
          recursive = true;
        };
        ...
        configFile."/home/x/.floorp/uyb507yq.default/chrome/userChrome.css".text = ''
